  ...
  return (
    <div>
      <div className='mb-2 flex items-center justify-between space-y-2'>
        <h1 className='font-bold text-2xl tracking-tight'>Domain Management</h1>
          ...
          <Drawer>
            ...
            <DrawerContent>
              <div className='mx-auto w-full max-w-lg'>
                <DrawerHeader>
                  <DrawerTitle>Add a domain</DrawerTitle>
                  <DrawerDescription>
                    Input a organizational domain name for user management
